...
insert into BODEGA (Nombre_Bodega, Email_Bodega, Direccion, Pais, Ciudad, Cuenta) values ('Establecimiento Juanico', 'establecimiento@gmail.com', 'Ruta 5 Km 30', 'Uruguay', 'Canelones', 27);
insert into BODEGA (Nombre_Bodega, Email_Bodega, Direccion, Pais, Ciudad, Cuenta) values ('Bodega Roses', 'bodegaroses@gmail.com', 'Ruta 6 S/N - Km 30,200', 'Uruguay', 'Canelones', 57);
insert into BODEGA (Nombre_Bodega, Email_Bodega, Direccion, Pais, Ciudad, Cuenta) values ('Concha y Toro', 'conchaytoro@gmail.com', 'Avenida Virginia Subercaseaux 210 9480092 Pirque', 'Chile', 'Santiago', 17);
...
insert into CLIENTES (CI_Cliente, Nombre_Cliente, Direccion, Ciudad, Email_Cliente, Contrasenia) values (51232348, 'Gonzalo Alvarez', 'Calle Ancha', 'Canelones', 'gonzalo@gmail.com', '4412f124fds');
insert into CLIENTES (CI_Cliente, Nombre_Cliente, Direccion, Ciudad, Email_Cliente, Contrasenia) values (52621318, 'Matias Alvarez', 'Cuareim', 'Las Piedras', 'matias@gmail.com', '441246f332f2');
insert into CLIENTES (CI_Cliente, Nombre_Cliente, Direccion, Ciudad, Email_Cliente, Contrasenia) values (54622309, 'Sergio Alvarez', 'San Isidro', 'Las Piedras', 'Sergio@gmail.com', '44122f2');
...
insert into EMPLEADOS (Nombre_Empleado, CI_Empleado, Salario, Email_Emplaedo, Contasenia) values ('Juan Carlos Rodrigez', 58240825, 25000, 'juancarlo@gmail.com', 'ewgdgw232523');
insert into EMPLEADOS (Nombre_Empleado, CI_Empleado, Salario, Email_Emplaedo, Contasenia) values ('Ramon Gutierrez', 58212825, 26000, 'ramon@gmail.com', 'ew121441dsg23');
insert into EMPLEADOS (Nombre_Empleado, CI_Empleado, Salario, Email_Emplaedo, Contasenia) values ('Pablo Perez', 58247659, 25000, 'pablo@gmail.com', 'ewdsgsdg32w123');
insert into EMPLEADOS (Nombre_Empleado, CI_Empleado, Salario, Email_Emplaedo, Contasenia) values ('Gonzalo Gimenez', 58128655, 25000, 'gonzalo@gmail.com', 'ewgasdaadsdqadq');
insert into EMPLEADOS (Nombre_Empleado, CI_Empleado, Salario, Email_Emplaedo, Contasenia) values ('Matias Martinez', 52240825, 25000, 'matias@gmail.com', 'ewgdgw23saf3');
...
insert into DETALLEVENTA (Cod_Venta, Vinos_DetalleV, Cantidad_DetalleV, Costo_DetalleDV) values (1, 1, 3, 72);
insert into DETALLEVENTA (Cod_Venta, Vinos_DetalleV, Cantidad_DetalleV, Costo_DetalleDV) values (2, 2, 2, 21);
insert into DETALLEVENTA (Cod_Venta, Vinos_DetalleV, Cantidad_DetalleV, Costo_DetalleDV) values (3, 3, 3, 54);
insert into DETALLEVENTA (Cod_Venta, Vinos_DetalleV, Cantidad_DetalleV, Costo_DetalleDV) values (4, 4, 4, 34);
insert into DETALLEVENTA (Cod_Venta, Vinos_DetalleV, Cantidad_DetalleV, Costo_DetalleDV) values (5, 5, 5, 76);
